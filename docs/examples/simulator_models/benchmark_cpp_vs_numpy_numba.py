...
This script is not executed on RTD (needs a compiled C++ extension and bakes
in wall-clock timings that would be meaningless on shared build hardware).
The gallery page shows its source plus a real, pre-rendered benchmark plot
generated by manually running it on real hardware - see
...
#
# .. figure:: /examples/simulator_models/reference_images/benchmark_cpp_vs_numpy_numba_001.png
#    :alt: NumPy vs Numba vs C++ sweep benchmark - wall time and speedup
#
#    10 nodes, 3 sweep sizes (4/8/16).
